...
**Ubicación:** Presencial en Córdoba Capital y modalidad online
...
**Cierre emocional:** Cuando algo se repite, no es casual. Es información que pide ser mirada, comprendida y ordenada.

---

## 3. UNA MIRADA INTEGRAL (Cambio posible)
...
El Método C.R.E.A. combina:

- **Constelaciones Familiares y Sistémicas**, para comprender los movimientos invisibles del sistema y el origen de los conflictos que hoy se manifiestan.
- **Biodecodificación y Reprogramación Bioneuroemocional y Biológica**, orientadas a liberar memorias emocionales y mentales que condicionan decisiones, vínculos y estados internos.
- **Lectura Akáshica aplicada al proceso terapéutico**, junto a otras herramientas de acompañamiento consciente, que se integran de acuerdo a lo que el momento y el alma necesitan.
...
## 5. ¿QUÉ SITUACIONES SE PUEDEN TRABAJAR? (SEO)
...
- Duración: 1 hora
- Modalidad: presencial en Córdoba Capital u online
...
## 8. UNA AGENDA CONSCIENTE (Quién acompaña)
...
**Título:** Todo lo que llega es una oportunidad para mirarte, ordenarte y crear algo nuevo
...
- Mensaje de WhatsApp predefinido (configurable en `NEXT_PUBLIC_WHATSAPP_MESSAGE` o en `app/lib/data/site.ts`)
- Navegación mínima: Inicio, Método C.R.E.A., Servicios, Contacto (anclas a secciones)
